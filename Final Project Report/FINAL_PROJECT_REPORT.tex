...
\begin{document}
	\begin{table}[t]
		...
		\begin{tabular}{| m{6cm} | m{6cm} |}
			...
			\hline
			Final Project Report & Date: 13-01-2017\\
			\hline
		\end{tabular}
	\end{table}
	\maketitle 
	...
	\begin{table}[h]
		...
		\begin{tabular}{| m{2cm} | m{2cm} | m{3cm} | m{5cm} |}
			...
			\hline
			13-01-2017 & 1.0 & Initial draft & Isabella Agosti\\
			\hline
			& & & \\
			\hline
		\end{tabular}
...
\newpage
	...
	\include{BackgroundAndObjectives}
	\include{Organization}
	\include{RequirementsDesignAndImplementation}
	\include{DevelopmentProcess}
\end{document}